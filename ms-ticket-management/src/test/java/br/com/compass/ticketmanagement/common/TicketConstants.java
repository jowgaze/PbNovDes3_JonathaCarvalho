...
public class TicketConstants {
    ...
    public static final TicketRequestDto TICKET_REQUEST_INVALID = new TicketRequestDto(
            "",
            "José",
            "jose@mail.com",
            "eventId",
    ...
    public static final List<TicketResponseDto> TICKET_RESPONSE_LIST = new ArrayList<>(Arrays.asList(
            TICKET_RESPONSE,
